...
output_file = "resnet-101.csv"

# Load the ResNet101V2 model and remove the final classification layer
base_model = ResNet101V2(weights='imagenet', include_top=False , pooling='max')
...
def extract_features(img_path):
    ...
    # Preprocess the image using the ResNet101V2 preprocess_input function
    x = np.expand_dims(img, axis=0)
    x = preprocess_input(x)

    # Extract features from the image using the ResNet101V2 model
